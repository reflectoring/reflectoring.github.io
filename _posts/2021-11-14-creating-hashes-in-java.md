...
author: pratikdas
excerpt: "A hash is a piece of text computed with a cryptographic hashing function. It is used for various purposes in the security domain like creating a checksum of a data file, generating signatures, and securely storing a piece of data as a digest instead of in the plain text. In this post, we will look at various types of hashes and how they are created in Java."
image:
  auto: 0074-stack
---
...
5. We can make a hash more secure by adding salt. Salt is a random piece of data that is used as an input in addition to the data that is inputted into the hashing function. 
6. The goal of salting is to defend against dictionary attacks or attacks against hashed passwords using a rainbow table.
7. Verifying data integrity is a common utility of hashes by the use of checksums. 
