...
The answer is that the creators of JUnit 5 intended it to be a powerful platform for running and managing tests and they didn't want to over-complicate it with a full capability of assertions. Instead, they designed the platform to be fully integrated with third party libraries such as Hamcrest.
