...
{{% github "https://github.com/thombergs/code-examples/tree/master/kotlin" %}}

## What Is Linting
Linting simply refers to the process of analyzing our code for any potential errors, typos or defects in formatting. This entire process is achieved by using a lint tool/ static code analyzer.
...
## Conclusion
In this tutorial, we have gone through the benefits of using Ktlint and how we can add it to our projects using Kotlin (Hopefully you shall consider adding it to your projects too).

If you want to get your hands dirty on the example code, have a look at the [github repository](https://github.com/thombergs/code-examples/tree/master/kotlin).
