...
6. We use the `LocaleResolver` interface for resolving the locale of a user from the incoming request. 
7. We internationalized a view in Spring MVC using Thymeleaf tags. 
