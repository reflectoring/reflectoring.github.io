...
2. **Install CDK Toolkit**: The AWS CDK Toolkit is the primary tool for interacting with the AWS CDK app through the CLI command `cdk`. It is an open-source project in [GitHub](https://github.com/aws/aws-cdk). Among its capabilities are producing and deploying the AWS CloudFormation templates generated by the AWS CDK. 
