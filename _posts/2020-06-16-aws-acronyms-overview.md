...
##  Choose Regions & AZs To Run Workloads
...
## Create VM With EC2
Next, we proceed to create our VM - Virtual Machine over which we can run our applications. **[EC2-Elastic Compute Cloud](https://aws.amazon.com/ec2/features/) is the service used to create VMs.**We create the VM as an EC2 instance using a pre-built machine image from Amazon (called AMI) or a custom image.** 
...
### Protect Your Instance With SG & Network ACL
