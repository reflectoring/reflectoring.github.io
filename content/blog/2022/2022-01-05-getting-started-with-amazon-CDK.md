...
Next, we will modify our stack class to define an infrastructure resource: [AWS EC2](https://aws.amazon.com/ec2/) with a [security group](https://docs.aws.amazon.com/vpc/latest/userguide/VPC_SecurityGroups.html) in a default [VPC](https://aws.amazon.com/vpc/):
